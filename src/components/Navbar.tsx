...
const Navbar = () => {
  return (
    <div>
      <div className="desktop flex justify-between items-center bg-black shadow-lg h-[60px] px-10">
        <div className="bg-gradient-to-r from-blue-600 via-green-500 to-indigo-400 inline-block text-transparent bg-clip-text font-bold text-2xl">
          <svg
            width="125"
            height="26"
            viewBox="0 0 135 36"
        ...
        <div className='text-white'><ThemeToggleButton/></div>
      </div>
